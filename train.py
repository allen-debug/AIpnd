...
def get_command_line_args():
    ...
    parser.add_argument('--save_dir', type=str,dest="save_dir", action="store", default='densenet121' ,
...
def main():
    ...
    dataloaders, class_to_idx = mod_file.get_loaders(args.data_dir)
    ...
    model, optimizer, criterion = mod_file.build_model(args.arch, args.hidden_units, args.learning_rate)
    ...
    mod_file.train_model(model, args.epochs, criterion, optimizer,
    ...
    test_loss, accuracy = mod_file.validate(model, criterion, dataloaders['testing'], use_gpu)
